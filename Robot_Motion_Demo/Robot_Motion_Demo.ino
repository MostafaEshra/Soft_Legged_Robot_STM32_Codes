...
void Backward_2Legs() {
  // Servo_2_Angle(servo2, 35);
  // Servo_2_Angle(servo3, 35);
  // Servo_2_Angle(servo8, 20);
  // Servo_2_Angle(servo6, 20);
  ...
  delay(1500);
  Servo_2_Angle(servo9, 0);
  Servo_2_Angle(servo7, 0);
  Servo_2_Angle(servo4, 0);
  Servo_2_Angle(servo5, 0);
  delay(1500);
